...
/*exec2_cmd*/
int						manage_cmd(t_tree *branch, t_pipe *info, int fd_in,
							int fd_out);
int						manage_my_cmd(t_tree *branch, t_pipe *info, int fd_in,
							int fd_out);

/*exec3_pipe*/
int						manage_pipe(t_tree *branch, t_pipe *info, int fd_in,
							int fd_out);
int						manage_conjunction(t_tree *branch, t_pipe *info,
							int fd_in, int fd_out);
int						manage_disjunction(t_tree *branch, t_pipe *info,
							int fd_in, int fd_out);
...
/*exec5_operate.c*/
int						tree_operator(t_tree *branch, t_pipe *info, int fd_in,
							int fd_out);
